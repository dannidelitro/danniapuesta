...
# Generate or update all 23 articles
for art in articles:
...
# Update blog/index.html to include all 23 links cleanly (newest first)
...
with open(blog_index_path, "w", encoding="utf-8") as f:
    f.write(idx_content)
print("Blog index updated con los 23 artículos Evergreen.")
