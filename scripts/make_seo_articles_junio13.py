...
articles = [
    ...
    },
    {
        ...
        <p>Poisson asume que los goles son eventos independientes (que el primer gol no afecta la probabilidad del segundo), lo cual no es strictly cierto en el fútbol real. Por ello, inversores avanzados aplican correcciones como el Filtro Dixon-Coles para afinar partidos donde el 0-0 y el 1-0 suceden con más frecuencia que la que dicta el modelo crudo.</p>
        """
    },
    {
...
with open(blog_index_path, "w", encoding="utf-8") as f:
    f.write(idx_content)
print("Blog index updated con los 38 artículos.")
