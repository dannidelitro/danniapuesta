...
# Generate or update all 13 articles
for art in articles:
...
# Update blog/index.html to include all 13 links cleanly (newest first)
...
with open(blog_index_path, "w", encoding="utf-8") as f:
    f.write(idx_content)
print("Blog index updated with all 13 Evergreen articles.")
