...
# Generate or update all 19 articles
for art in articles:
...
# Update blog/index.html to include all 19 links cleanly (newest first)
...
with open(blog_index_path, "w", encoding="utf-8") as f:
    f.write(idx_content)
print("Blog index updated with all 19 Evergreen articles.")
