...
articles = [
    ...
    },
    {
        ...
        <p>Cuando equipos como Al Minaa (en la Stars League iraquí) o colistas en cualquier otra liga se juegan la permanencia, el miedo a encajar un gol destruye la creatividad. El juego se vuelve áspero, lleno de interrupciones, faltas tácticas en el mediocampo y protestas sistemáticas al árbitro.</p>
        ...
        <p>Las casas de apuestas suelen fijar la línea base (Over 3.5 o Over 4.5) basándose en los promedios globales de la temporada. Esto es un error, ya que no contemplan que la presión por el descenso incrementa exponencialmente la agresividad en el tercio final de la campaña. Esta ceguera del algoritmo de la casa es puro Valor Esperado Positivo (EV+) para el apostador.</p>
        """
    }
]
...
# Generate or update all 11 articles
for art in articles:
...
# Update blog/index.html to include all 11 links cleanly (newest first)
...
with open(blog_index_path, "w", encoding="utf-8") as f:
    f.write(idx_content)
print("Blog index updated with all 11 Evergreen articles.")
