...
articles = [
    ...
    },
    {
        ...
        "body": """
        <p>Los modelos predictivos suelen asumir condiciones meteorológicas neutrales. Sin embargo, torneos disputados bajo <strong>calor extremo</strong> (superando los 35°C), capitan, como el Mundial de 2026 o ciertas ligas de Oriente Medio, alteran por completo el flujo fisiológico de un partido.</p>
...
with open(blog_index_path, "w", encoding="utf-8") as f:
    f.write(idx_content)
print("Blog index updated con los 29 artículos Evergreen.")
